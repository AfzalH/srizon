        ...
        <div className="row">
          ...
          <div className="col-xs-12">
            <nav className="left-menu">
              <ul>
                <li><Link to="/" activeClassName={(this.props.path === '/') ? 'active' : ''}>Home<i
                  className="fa fa-home"></i></Link></li>
                ...
                <li><Link to="/support" activeClassName="active">Support/Contact<i className="fa fa-home"></i></Link>
                </li>
